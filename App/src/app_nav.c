...
#define GPS_POSITION_SOURCE_ENTER_MAX_RMC_MPS 0.35f
#define GPS_RMC_SOURCE_RETURN_MIN_SPEED_MPS 0.65f

#define GPS_POSITION_FALLBACK_MAX_SPEED_MPS 0.80f

#define GPS_VELOCITY_SOURCE_CONFIRM_SAMPLES 3U
...
#define GPS_POSITION_VELOCITY_HISTORY_SIZE 6U
#define GPS_POSITION_VELOCITY_MIN_SAMPLES 5U
#define GPS_POSITION_VELOCITY_MIN_WINDOW_MS 700U
#define GPS_POSITION_VELOCITY_MAX_WINDOW_MS 1400U
                                        ...
                                        bool new_rmc_sample)
{
    ...
    uint8_t required_samples = GPS_VELOCITY_SOURCE_CONFIRM_SAMPLES;
